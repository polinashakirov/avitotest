...
## TC-13: Введение в поле "sellerId" значения вне класса
### Шаги
Отправить Post запрос https://qa-internship.avito.com/api/1/item
```
    {
...
## TC-15: Введение в поля "statistics" значения null 
### Шаги
Отправить Post запрос https://qa-internship.avito.com/api/1/item
```
    {
...
## TC-16: Введение в поля "statistics" отрицательного значения 
### Шаги
Отправить Post запрос https://qa-internship.avito.com/api/1/item
```
    {
...
## TC-17: Введение в поля "statistics" больших значений 
### Шаги
Отправить Post запрос https://qa-internship.avito.com/api/1/item
```
    {
...
## TC-18: Введение в Body пустой JSON 
### Шаги
Отправить Post запрос https://qa-internship.avito.com/api/1/item
```
    {
...
## TC-19: Введение запроса с пустым Body 
### Шаги
Отправить Post запрос https://qa-internship.avito.com/api/1/item
```
...
## TC-22: Отсутствие поля "sellerId" 
### Шаги
Отправить Post запрос https://qa-internship.avito.com/api/1/item
```
     {
...
## TC-23: Отсутствие полей "statistics" 
### Шаги
Отправить Post запрос https://qa-internship.avito.com/api/1/item
```
     {
...
## TC-24: Отсутствие поля "statistics" 
### Шаги
Отправить Post запрос https://qa-internship.avito.com/api/1/item
```
     {
...
## TC-25: Введение корректного идентификатора
### Предусловие
...
## TC-26: Введение некорректного идентификатора 
### Предусловие
1. Создать объявление
2. Скопировать уникальный индентификатор
### Шаги
...
## TC-27: Введение пустого идентификатора 
### Шаги
1. Отправить GET запрос https://qa-internship.avito.com/api/1/item/:id
...
## TC-28: Введение корректного id продавца
### Предусловие
1. Создать объявление
...
## TC-29: Введение некорректного id продавца
### Предусловие
1. Создать объявление
2. Скопировать id продавца
### Шаги
...
## TC-30: Введение пустого id продавца
