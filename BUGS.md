## AT-1: В GET запросе на получение объявления при введении корректного идентификатора в ответе объявление и название одного из полей не соответствует ранее созданному
...
4. Вместо ":id" ввести ранее скопированный уникальный идентификатор
...
4. Вместо поля ":sellerID" ввести ранее скопированный id продавца
#### Ожидаемый результат: статус: 200, ответ пришел без ошибок и соответствует созданному объявлению
#### Фактический результат: в ответе поле "likes" не соответствует созданному объявлению
...
2. Поле ":sellerID" оставить пустым
